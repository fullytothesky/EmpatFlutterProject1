...
void main() {
  ...
  String studentFio = instance1.fullname;

  runApp(
    //function that accept some Widgets to display on the screen
    MaterialApp(
      home: Scaffold(
        //Scaffold is a Widget that applies basic Material Design visual layout structure.
